...
function App() {
  ...
  return (
    <>
      <style>
        {`.public-DraftEditorPlaceholder-root{position: absolute;top:2px;line-height:24px;font-size:16px;color: #969696;pointer-events: none;z-index: -10000;}${editorStyleSheet}`}
      </style>
      <Editor
        ref={_draftEditorRef}
